        ...
        child: Column(
          children: [
            ...
            Stack(alignment: Alignment.centerRight, children: [
              SvgPicture.string(
                '<svg viewBox="475.0 874.0 413.0 84.0" ><path transform="translate(475.0, 918.0)" d="M 0 -43.99999618530273 L 413.0000305175781 -43.99999618530273 L 413.0000305175781 40.00000381469727 L 0 40.00000381469727 L 0 -43.99999618530273 Z" fill="#2f2e41" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>',
                allowDrawingOutsideViewBox: true,
                fit: BoxFit.fill,
              ),
              Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 146.0, 50.0),
                    size: Size(146.0, 50.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(57.0, 21.0, 32.0, 12.0),
                    size: Size(146.0, 50.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
