  ...
  Widget build(BuildContext context) {
    ...
    Future<void> downloadFileExample(String filename) async {
      ...
      await firebase_storage.FirebaseStorage.instance
          .ref(widget.uid + '/Invoice/' + filename + '.pdf')
    ...
    Future<void> downloadFileExampleopen(String filename) async {
      Directory appDocDir = await getApplicationDocumentsDirectory();
      File downloadToFile = File('${appDocDir.path}/$filename.pdf');
    ...
    return Scaffold(
        ...
        body: Padding(
          padding: const EdgeInsets.all(30.1),
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.only(bottom :38.1),
                  child: Stack(
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                              onTap: () {
                                                downloadFileExample(snapshot
                                                    .data.docs[index]['invoiceno']);
                                              },
                                              child: Icon(
                                                Icons.share,
                                              ))
